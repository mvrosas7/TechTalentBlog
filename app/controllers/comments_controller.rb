...
def update
 ...
 def destroy
 	...
 	respond_to do |format|
 		format.html {redirect_to blog_post_path(id: @comment.blog_post_id), notice: "Your comment was DESTROYEDDDDD!!!"}
 	end
...
def comment_params
	params.required(:comment).permit(:author, :comment_entry, :blog_post_id)
end
